...
<form action="donorlogin.php" method="post">
  <table class="table table-responsive table-bordered" width="40%" align="center">
	 ...
	 <tr>
       <td ><input type="hidden" name="cat1" id="cat1" value="donor"></td>
	 </tr>
	 <tr>
	 ...
	 <tr>
       <td align="center" colspan="2"><a href="donor_register.php" style="color:#c5eff7">Register Here</a></td>
	 </tr>
  </table>
</form>
</div>
...
include('connect.php');
	...
	if(isset($_POST['submit']))
	{
		 ...
		 $cat1 = $_POST['cat1'];
		$query = "select * from donor_register where email='$email' AND password='$password' AND cat1='$cat1'";	
...
echo "<font color='red' size='3px' > you are already login ............</font>";
		header('refresh:2, url=donorprofile.php');
	}
