...
<div class="header" style="background:#2e4053; height:100%; margin:0; padding:0;">
	...
	<div class="col-md-12">
	  <div class="col-md-2">
	   ...
	   <div class="col-md-8">
<form method="post" action="patient_register.php" name="myForm">
<center>
<table class="table table-bordered table-responsive" width="100%">
<tr>
	<td colspan="4" style="color:white;"><center><h4>Patient Registration Form</h4></center></td>>
</tr>
<tr>
	...
	<td><input type="number" size="6" name="age" min="1" max="100" value="21"><p style="color:#c5eff7;">Above 18 and below 55</p></td>
</tr>
<tr>
...
<tr >
	<td>
	<input type="hidden" name="cat2" id="cat2" value="patient">
	</td>
</tr>
<tr >
	<td colspan="4"><center>
...
if(isset($_POST['submit'])){
	...
	if($password==$cpassword){
		$query = "INSERT INTO patient_register(name,age,email,password,username,weight,blood_group,gender,contact,address,city,cat2)
		VALUES('$name','$age','$email','$password','$username','$weight','$group','$gender','$contact','$address','$city','$cat2')";
